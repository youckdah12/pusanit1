...
<%
		...
		int totalBlock=0;//총 블럭 수 =(올림)총 페이지 수/블럭당 페이지수
		...
		//totalRecord=mgr.getTotalCount("name","이승기");
...
<script type="text/javascript">
	...
	function list(){
		document.listFrm.action="list.jsp"; //주소창 간단하게 
...
<table>
	<tr>
		...
		int listSize=vlist.size();//브라우저 화면에 보여질 게시물번호 
		if(vlist.isEmpty()){
				out.println("등록된 게시문리 없습니다.");
		}else{
			%>
			<table cellspacing="0">
